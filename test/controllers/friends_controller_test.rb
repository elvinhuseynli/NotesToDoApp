...
class FriendsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create friend" do
    assert_difference("Friend.count") do
      post friends_url, params: { friend: { friend_id: @friend.friend_id, status: @friend.status } }
    end
  ...
  test "should update friend" do
    patch friend_url(@friend), params: { friend: { friend_id: @friend.friend_id, status: @friend.status } }
